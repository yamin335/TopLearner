...
data class ClassWiseBook(var id: Int, val udid: String?, val name: String?, val title: String?, val author: String?, var isPaid: Boolean?, val book_type_id: Number?):Serializable
