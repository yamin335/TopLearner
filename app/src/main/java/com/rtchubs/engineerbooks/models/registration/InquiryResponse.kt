...
data class InquiryAccount(var udid: String?, var createdAt: String?, var updatedAt: String?, var id: Int?,
                          ...
                          var mother_name: String?, var father_name: String?,
                          var discount_amount: Double?, var blood: String?,
                          var designation_type: String?, var promo_code: String?, var no_of_students: Int?): Serializable
